                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <a href="/siswa/{{$siswa->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('yakin akan menghapus?')">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
...
<div class="form-group">
    ...
    <textarea name="alamat" class="form-control" id="alamat" rows="3" placeholder="Alamat">{{old('alamat')}}</textarea>
</div>
